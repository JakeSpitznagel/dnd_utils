from man_spells import spell


@spell
def acid_arrow(upcast=None):
    '''
    Acid Arrow
    2nd-level evocation
    ...
    '''
    print(acid_arrow.__doc__)


@spell
def acid_splash(upcast=None):
    '''
    Acid Splash
    Conjuration cantrip
    Casting Time: 1 action
...
def alter_self(upcast=None):
    ...
    '''
    print(alter_self.__doc__)


@spell
def animal_friendship(upcast=None):
    '''
    Animal Friendship
    ...
    '''
    print(animal_friendship.__doc__)


@spell
def animal_messenger(upcast=None):
    '''
    Animal Messenger
    ...
    '''
    print(animal_messenger.__doc__)


@spell
def animal_shapes(upcast=None):
    '''
    Animal Shapes
    ...
    '''
    print(animal_shapes.__doc__)


@spell
def animate_dead(upcast=None):
    '''
    Animate Dead
    ...
    '''
    print(animate_dead.__doc__)


@spell
def animate_objects(upcast=None):
    '''
    Animate Objects
    ...
    Animated Object StatisticsSize
    HP
    AC
    Str
    Dex
    ...
    4
    18
    +8 to hit, 1d4 + 4 damageSmall
    25
    16
    6
    14
    +6 to hit, 1d8 + 2 damageMedium
    40
    13
    10
    12
    +5 to hit, 2d6 + 1 damageLarge
    50
    10
    14
    10
    +6 to hit, 2d10 + 2 damageHuge
    80
    10
    18
    6
    +8 to hit, 2d12 + 4 damageAn animated object is a construct with AC, hit points, attacks, Strength, and Dexterity determined by its size.
    ...
    '''
    print(animate_objects.__doc__)


@spell
def antilife_shell(upcast=None):
    '''
    Antilife Shell
    ...
    '''
    print(antilife_shell.__doc__)


@spell
def antimagic_field(upcast=None):
    '''
    Antimagic Field
    ...
    A 10-foot-radius invisible sphere of antimagic surrounds you.
     ...
     Within the sphere, spells canft be cast, summoned creatures disappear, and even magic items become mundane.
    ...
    '''
    print(antimagic_field.__doc__)


@spell
def antipathy_sympathy(upcast=None):
    '''
    Antipathy/Sympathy
    ...
    '''
    print(antipathy_sympathy.__doc__)


@spell
def arcane_eye(upcast=None):
    '''
    Arcane Eye
    ...
    '''
    print(arcane_eye.__doc__)


@spell
def arcane_hand(upcast=None):
    '''
    Arcane Hand
    5th-level evocation 
    Casting Time: 1 action 
    ...
    '''
    print(arcane_hand.__doc__)


@spell
def arcane_lock(upcast=None):
    '''
    Arcane Lock
    2nd-level abjuration 
    Casting Time: 1 action 
    ...
    '''
    print(arcane_lock.__doc__)


@spell
def arcane_sword(upcast=None):
    '''
    Arcane Sword
    7th-level evocation 
    Casting Time: 1 action 
    ...
    '''
    print(arcane_sword.__doc__)


@spell
def arcanist_s_magic_aura(upcast=None):
    '''
    ...
    '''
    print(arcanist_s_magic_aura.__doc__)


@spell
def astral_projection(upcast=None):
    '''
    Astral Projection
    ...
    The spell might also end early for you or one of your companions.
     A successful dispel magic spell used against an astral or physical body ends the spell for that creature.
    ...
    '''
    print(astral_projection.__doc__)


@spell
def augury(upcast=None):
    '''
    Augury
    ...
    By casting gem-inlaid sticks, rolling dragon bones, laying out ornate cards, or employing some other divining tool, you receive an omen from an otherworldly entity about the results of a specific course of action that you plan to take within the next 30 minutes.
     The GM chooses from the following possible omens:Weal, for good results
    Woe, for bad results
    ...
    '''
    print(augury.__doc__)


@spell
def awaken(upcast=None):
    '''
    Awaken
    5th-level transmutation 
    ...
    '''
    print(awaken.__doc__)


@spell
def bane(upcast=None):
    '''
    Bane
    1st-level enchantment 
    Casting Time: 1 action 
...
def banishment(upcast=None):
    ...
    '''
    print(banishment.__doc__)


@spell
def barkskin(upcast=None):
    '''
    Barkskin
    2nd-level transmutation 
    Casting Time: 1 action  
    ...
    '''
    print(barkskin.__doc__)


@spell
def beacon_of_hope(upcast=None):
    '''
    Beacon of Hope
    ...
    '''
    print(beacon_of_hope.__doc__)


@spell
def bestow_curse(upcast=None):
    '''
    Bestow Curse
    3rd-level necromancy 
    Casting Time: 1 action 
    ...
    You touch a creature, and that creature must succeed on a Wisdom saving throw or become cursed for the duration of the spell.
     When you cast this spell, choose the nature of the curse from the following options:Choose one ability score.
    ...
    While the target is cursed, your attacks and spells deal an extra 1d8 necrotic damage to the target.
     ...
     The GM has final say on such a curse's effect.
    ...
    '''
    print(bestow_curse.__doc__)


@spell
def black_tentacles(upcast=None):
    '''
    Black Tentacles
    ...
    '''
    print(black_tentacles.__doc__)


@spell
def blade_barrier(upcast=None):
    '''
    Blade Barrier
    6th-level evocation 
    Casting Time: 1 action 
    ...
    '''
    print(blade_barrier.__doc__)


@spell
def bless(upcast=None):
    '''
    Bless
    1st-level enchantment 
    Casting Time: 1 action 
...
def blight(upcast=None):
    ...
    '''
    print(blight.__doc__)


@spell
def blindness_deafness(upcast=None):
    '''
    Blindness/Deafness
    ...
    '''
    print(blindness_deafness.__doc__)


@spell
def blink(upcast=None):
    '''
    Blink
...
@spell
def branding_smite(upcast=None):
    '''
    Branding Smite
    2nd-level evocation
    ...
    '''
    print(branding_smite.__doc__)


@spell
def burning_hands(upcast=None):
    '''
    Burning Hands
    1st-level evocation 
    Casting Time: 1 action 
    ...
    '''
    print(burning_hands.__doc__)


@spell
def call_lightning(upcast=None):
    '''
    Call Lightning
    ...
    '''
    print(call_lightning.__doc__)


@spell
def calm_emotions(upcast=None):
    '''
    Calm Emotions
    ...
    '''
    print(calm_emotions.__doc__)


@spell
def chain_lightning(upcast=None):
    '''
    Chain Lightning
    6th-level evocation 
    Casting Time: 1 action  
    ...
    '''
    print(chain_lightning.__doc__)


@spell
def charm_person(upcast=None):
    '''
    Charm Person
    1st-level enchantment 
    Casting Time: 1 action  
    ...
    '''
    print(charm_person.__doc__)


@spell
def chill_touch(upcast=None):
    '''
    Chill Touch
    Necromancy cantrip 
    Casting Time: 1 action  
    ...
    '''
    print(chill_touch.__doc__)


@spell
def circle_of_death(upcast=None):
    '''
    Circle of Death
    ...
    '''
    print(circle_of_death.__doc__)


@spell
def clairvoyance(upcast=None):
    '''
    Clairvoyance
    ...
    '''
    print(clairvoyance.__doc__)


@spell
def clone(upcast=None):
    '''
    Clone
...
def cloudkill(upcast=None):
    ...
    '''
    print(cloudkill.__doc__)


@spell
def color_spray(upcast=None):
    '''
    Color Spray
    1st-level illusion 
    Casting Time: 1 action 
    ...
    '''
    print(color_spray.__doc__)


@spell
def command(upcast=None):
    '''
    Command
    1st-level enchantment 
    Casting Time: 1 action 
...
def commune(upcast=None):
    ...
    If you cast the spell two or more times before finishing your next long rest, there is a cumulative 25 percent chance for each casting after the first that you get no answer.
     The GM makes this roll in secret.
    '''
    print(commune.__doc__)


@spell
def commune_with_nature(upcast=None):
    '''
    Commune with Nature
    5th-level divination (ritual) 
    Casting Time: 1 minute  
    ...
    You instantly gain knowledge of up to three facts of your choice about any of the following subjects as they relate to the area:terrain and bodies of water
    ...
    '''
    print(commune_with_nature.__doc__)


@spell
def comprehend_languages(upcast=None):
    '''
    ...
    '''
    print(comprehend_languages.__doc__)


@spell
def compulsion(upcast=None):
    '''
    Compulsion
    ...
    Creatures of your choice that you can see within range and that can hear you must make a Wisdom saving throw.
     ...
     After moving in this way, it can make another Wisdom saving to try to end the effect.
      
    A target isn't compelled to move into an obviously deadly hazard, such as a fire or pit, but it will provoke opportunity attacks to move in the designated direction.
    '''
    print(compulsion.__doc__)


@spell
def cone_of_cold(upcast=None):
    '''
    5th-level evocation 
    Casting Time: 1 action  
    ...
    At Higher Levels.
     When you cast this spell using a spell slot of 6th level or higher, the damage increases by 1d8 for each slot level above 5th.
    '''
    print(cone_of_cold.__doc__)


@spell
def confusion(upcast=None):
    '''
    Confusion
    4th-level enchantment 
    Casting Time: 1 action  
...
@spell
def conjure_animals(upcast=None):
    '''
    Conjure Animals
    3rd-level conjuration 
    Casting Time: 1 action  
    ...
    You summon fey spirits that take the form of beasts and appear in unoccupied spaces that you can see within range.
     Choose one of the following options for what appears: One beast of challenge rating 2 or lower
    ...
    '''
    print(conjure_animals.__doc__)


@spell
def conjure_celestial(upcast=None):
    '''
    Conjure Celestial
    ...
    '''
    print(conjure_celestial.__doc__)


@spell
def conjure_elemental(upcast=None):
    '''
    Conjure Elemental
    5th-level conjuration 
    Casting Time: 1 minute  
    ...
    '''
    print(conjure_elemental.__doc__)


@spell
def conjure_fey(upcast=None):
    '''
    Conjure Fey
    ...
    '''
    print(conjure_fey.__doc__)


@spell
def conjure_minor_elementals(upcast=None):
    '''
    ...
    You summon elementals that appear in unoccupied spaces that you can see within range.
     You choose one the following options for what appears: One elemental of challenge rating 2 or lower
    ...
    '''
    print(conjure_minor_elementals.__doc__)


@spell
def conjure_woodland_beings(upcast=None):
    '''
    ...
    You summon fey creatures that appear in unoccupied spaces that you can see within range.
     Choose one of the following options for what appears:One fey creature of challenge rating 2 or lower 
    ...
    At Higher Levels.
     When you cast this spell using certain higher-level spell slots, you choose one of the summoning options above, and more creatures appear: twice as many with a 6th-level slot and three times as many with an 8th-level slot.
    '''
    print(conjure_woodland_beings.__doc__)


@spell
def contact_other_plane(upcast=None):
    '''
    Contact Other Plane
    5th-level divination (ritual) 
    Casting Time: 1 minute  
    ...
    '''
    print(contact_other_plane.__doc__)


@spell
def contagion(upcast=None):
    '''
    Contagion
    ...
    '''
    print(contagion.__doc__)


@spell
def contingency(upcast=None):
    '''
    Contingency
    6th-level evocation 
    Casting Time: 10 minutes  
    ...
    '''
    print(contingency.__doc__)


@spell
def continual_flame(upcast=None):
    '''
    Continual Flame
    2nd-level evocation 
    Casting Time: 1 action  
    ...
    '''
    print(continual_flame.__doc__)


@spell
def control_water(upcast=None):
    '''
    Control Water
    ...
    '''
    print(control_water.__doc__)


@spell
def control_weather(upcast=None):
    '''
    Control Weather
    8th-level transmutation 
    Casting Time: 10 minutes  
    ...
    Clear2
    Light clouds3
    Overcast or ground fog4
    Rain, hail or snow5
    Torrential rain, driving hail, or blizzardTemperatureStage
    Condition1
    Unbearable heat2
    Hot3
    Warm4
    ...
    Storm
    '''
    print(control_weather.__doc__)


@spell
def counterspell(upcast=None):
    '''
    Counterspell
    3rd-level abjuration 
    ...
    '''
    print(counterspell.__doc__)


@spell
def create_food_and_water(upcast=None):
    '''
    ...
    '''
    print(create_food_and_water.__doc__)


@spell
def create_undead(upcast=None):
    '''
    Create Undead
    6th-level necromancy 
    Casting Time: 1 minute  
    ...
    '''
    print(create_undead.__doc__)


@spell
def create_or_destroy_water(upcast=None):
    '''
    ...
    '''
    print(create_or_destroy_water.__doc__)


@spell
def creation(upcast=None):
    '''
    Creation
    5th-level illusion 
    Casting Time: 1 minute  
    ...
    The duration depends on the object's material.
     ...
     Material
    DurationVegetable matter
    1 dayStone or crystal
    12 hoursPrecious metals
    1 hourGems
    10 minutesAdamantine or mithral
    1 minuteUsing any material created by this spell as another spell's material component causes that spell to fail.
    ...
    '''
    print(creation.__doc__)


@spell
def cure_wounds(upcast=None):
    '''
    Cure Wounds
    1st-level evocation 
    Casting Time: 1 action  
    ...
    '''
    print(cure_wounds.__doc__)


@spell
def dancing_lights(upcast=None):
    '''
    Dancing Lights
    Evocation cantrip 
    Casting Time: 1 action  
    ...
    '''
    print(dancing_lights.__doc__)


@spell
def darkness(upcast=None):
    '''
    Darkness
    2nd-level evocation 
    Casting Time: 1 action  
    ...
    '''
    print(darkness.__doc__)


@spell
def darkvision(upcast=None):
    '''
    Darkvision
    2nd-level transmutation 
    Casting Time: 1 action  
    ...
    '''
    print(darkvision.__doc__)


@spell
def daylight(upcast=None):
    '''
    Daylight
    3rd-level evocation 
    Casting Time: 1 action  
    ...
    '''
    print(daylight.__doc__)


@spell
def death_ward(upcast=None):
    '''
    Death Ward
    4th-level abjuration 
    Casting Time: 1 action  
    ...
    '''
    print(death_ward.__doc__)


@spell
def delayed_blast_fireball(upcast=None):
    '''
    ...
    '''
    print(delayed_blast_fireball.__doc__)


@spell
def demiplane(upcast=None):
    '''
    Demiplane
    ...
    '''
    print(demiplane.__doc__)


@spell
def detect_evil_and_good(upcast=None):
    '''
    ...
    '''
    print(detect_evil_and_good.__doc__)


@spell
def detect_magic(upcast=None):
    '''
    Detect Magic
    1st-level divination (ritual) 
    Casting Time: 1 action  
    ...
    The spell can penetrate most barriers, but it is blocked by 1 foot of stone, 1 inch of common metal, a thin sheet of lead, or 3 feet of wood or dirt.
    '''
    print(detect_magic.__doc__)


@spell
def detect_poison_and_disease(upcast=None):
    '''
    ...
    The spell can penetrate most barriers, but it is blocked by 1 foot of stone, 1 inch of common metal, a thin sheet of lead, or 3 feet of wood or dirt.
    '''
    print(detect_poison_and_disease.__doc__)


@spell
def detect_thoughts(upcast=None):
    '''
    Detect Thoughts
    ...
    '''
    print(detect_thoughts.__doc__)


@spell
def dimension_door(upcast=None):
    '''
    Dimension Door
    4th-level conjuration 
    Casting Time: 1 action  
    ...
    '''
    print(dimension_door.__doc__)


@spell
def disguise_self(upcast=None):
    '''
    Disguise Self
    1st-level illusion 
    Casting Time: 1 action  
    ...
    '''
    print(disguise_self.__doc__)


@spell
def disintegrate(upcast=None):
    '''
    Disintegrate
    ...
    '''
    print(disintegrate.__doc__)


@spell
def dispel_evil_and_good(upcast=None):
    '''
    ...
    '''
    print(dispel_evil_and_good.__doc__)


@spell
def dispel_magic(upcast=None):
    '''
    Dispel Magic
    3rd-level abjuration 
    Casting Time: 1 action  
    ...
    '''
    print(dispel_magic.__doc__)


@spell
def divination(upcast=None):
    '''
    Divination
    ...
    If you cast the spell two or more times before finishing your next long rest, there is a cumulative 25 percent chance for each casting after the first that you get a random reading.
     The GM makes this roll in secret.
    '''
    print(divination.__doc__)


@spell
def divine_favor(upcast=None):
    '''
    Divine Favor
    1st-level evocation 
    Casting Time: 1 bonus action  
    ...
    '''
    print(divine_favor.__doc__)


@spell
def divine_word(upcast=None):
    '''
    Divine Word
    7th-level evocation 
    Casting Time: 1 bonus action  
    ...
    You utter a divine word, imbued with the power that shaped the world at the dawn of creation.
     ...
     On a failed save, a creature suffers an effect based on its current hit points:50 hit points or fewer: deafened for 1 minute
    ...
    '''
    print(divine_word.__doc__)


@spell
def dominate_beast(upcast=None):
    '''
    Dominate Beast
    4th-level enchantment 
    Casting Time: 1 action  
    ...
    '''
    print(dominate_beast.__doc__)


@spell
def dominate_monster(upcast=None):
    '''
    Dominate Monster
    8th-level enchantment 
    Casting Time: 1 action  
    ...
    '''
    print(dominate_monster.__doc__)


@spell
def dominate_person(upcast=None):
    '''
    Dominate Person
    ...
    '''
    print(dominate_person.__doc__)


@spell
def dream(upcast=None):
    '''
    Dream
    5th-level illusion 
    Casting Time: 1 minute  
...
def druidcraft(upcast=None):
    ...
    '''
    print(druidcraft.__doc__)


@spell
def earthquake(upcast=None):
    '''
    Earthquake
    8th-level evocation 
    Casting Time: 1 action  
    ...
    '''
    print(earthquake.__doc__)


@spell
def eldritch_blast(upcast=None):
    '''
    Eldritch Blast
    Evocation cantrip 
    Casting Time: 1 action  
    ...
    '''
    print(eldritch_blast.__doc__)


@spell
def enhance_ability(upcast=None):
    '''
    Enhance Ability
    2nd-level transmutation 
    Casting Time: 1 action  
    ...
    At Higher Levels.
     When you cast this spell using a spell slot of 3rd level or higher, you can target one additional creature for each slot level above 2nd.
    '''
    print(enhance_ability.__doc__)


@spell
def enlarge_reduce(upcast=None):
    '''
    Enlarge/Reduce
    2nd-level transmutation 
    Casting Time: 1 action  
    ...
    '''
    print(enlarge_reduce.__doc__)


@spell
def entangle(upcast=None):
    '''
    Entangle
    ...
    '''
    print(entangle.__doc__)


@spell
def enthrall(upcast=None):
    '''
    Enthrall
    2nd-level enchantment 
    Casting Time: 1 action  
    ...
    '''
    print(enthrall.__doc__)


@spell
def etherealness(upcast=None):
    '''
    Etherealness
    ...
    '''
    print(etherealness.__doc__)


@spell
def expeditious_retreat(upcast=None):
    '''
    Expeditious Retreat
    1st-level transmutation 
    Casting Time: 1 bonus action  
    ...
    '''
    print(expeditious_retreat.__doc__)


@spell
def eyebite(upcast=None):
    '''
    Eyebite
    6th-level necromancy 
    Casting Time: 1 action  
    ...
    '''
    print(eyebite.__doc__)


@spell
def fabricate(upcast=None):
    '''
    Fabricate
    4th-level transmutation 
    Casting Time: 10 minutes  
    ...
    '''
    print(fabricate.__doc__)


@spell
def faerie_fire(upcast=None):
    '''
    Faerie Fire
    1st-level evocation 
    Casting Time: 1 action  
    ...
    '''
    print(faerie_fire.__doc__)


@spell
def faithful_hound(upcast=None):
    '''
    Faithful Hound
    4th-level conjuration 
    Casting Time: 1 action  
    ...
    '''
    print(faithful_hound.__doc__)


@spell
def false_life(upcast=None):
    '''
    False Life
    ...
    '''
    print(false_life.__doc__)


@spell
def fear(upcast=None):
    '''
    Fear
    3rd-level illusion 
    Casting Time: 1 action  
...
def feather_fall(upcast=None):
    ...
    '''
    print(feather_fall.__doc__)


@spell
def feeblemind(upcast=None):
    '''
    Feeblemind
    8th-level enchantment 
    Casting Time: 1 action  
...
def find_steed(upcast=None):
    ...
    '''
    print(find_steed.__doc__)


@spell
def find_traps(upcast=None):
    '''
    Find Traps
    2nd-level divination 
    Casting Time: 1 action  
    ...
    '''
    print(find_traps.__doc__)


@spell
def find_the_path(upcast=None):
    '''
    Find the Path
    ...
    '''
    print(find_the_path.__doc__)


@spell
def finger_of_death(upcast=None):
    '''
    Finger of Death
    ...
    '''
    print(finger_of_death.__doc__)


@spell
def fire_bolt(upcast=None):
    '''
    Fire Bolt
    Evocation cantrip 
    Casting Time: 1 action  
    ...
    '''
    print(fire_bolt.__doc__)


@spell
def fire_shield(upcast=None):
    '''
    Fire Shield
    4th-level evocation 
    Casting Time: 1 action  
    ...
    '''
    print(fire_shield.__doc__)


@spell
def fire_storm(upcast=None):
    '''
    Fire Storm
    7th-level evocation 
    Casting Time: 1 action  
...
def fireball(upcast=None):
    ...
    '''
    print(fireball.__doc__)


@spell
def flame_blade(upcast=None):
    '''
    Flame Blade
    2nd-level evocation 
    Casting Time: 1 bonus action  
    ...
    '''
    print(flame_blade.__doc__)


@spell
def flame_strike(upcast=None):
    '''
    Flame Strike
    5th-level evocation 
    Casting Time: 1 action  
    ...
    '''
    print(flame_strike.__doc__)


@spell
def flaming_sphere(upcast=None):
    '''
    Flaming Sphere
    2nd-level conjuration 
    Casting Time: 1 action  
    ...
    '''
    print(flaming_sphere.__doc__)


@spell
def flesh_to_stone(upcast=None):
    '''
    Flesh to Stone
    6th-level transmutation 
    Casting Time: 1 action  
    ...
    '''
    print(flesh_to_stone.__doc__)


@spell
def floating_disk(upcast=None):
    '''
    Floating Disk
    1st-level conjuration (ritual) 
    Casting Time: 1 action  
...
def fog_cloud(upcast=None):
    ...
    '''
    print(fog_cloud.__doc__)


@spell
def forbiddance(upcast=None):
    '''
    Forbiddance
    ...
    '''
    print(forbiddance.__doc__)


@spell
def forcecage(upcast=None):
    '''
    Forcecage
    7th-level evocation 
    Casting Time: 1 action  
    ...
    '''
    print(forcecage.__doc__)


@spell
def foresight(upcast=None):
    '''
    Foresight
    ...
    '''
    print(foresight.__doc__)


@spell
def freedom_of_movement(upcast=None):
    '''
    Freedom of Movement
    4th-level abjuration 
    Casting Time: 1 action  
    ...
    '''
    print(freedom_of_movement.__doc__)


@spell
def freezing_sphere(upcast=None):
    '''
    Freezing Sphere
    6th-level evocation 
    Casting Time: 1 action  
    ...
    '''
    print(freezing_sphere.__doc__)


@spell
def gaseous_form(upcast=None):
    '''
    Gaseous Form
    3rd-level transmutation 
    Casting Time: 1 action  
    ...
    '''
    print(gaseous_form.__doc__)


@spell
def gate(upcast=None):
    '''
    Gate
    ...
    When you cast this spell, you can speak the name of a specific creature (a pseudonym, title, or nickname doesn't work).
     ...
     You gain no special power over the creature, and it is free to act as the GM deems appropriate.
...
def gentle_repose(upcast=None):
    ...
    '''
    print(gentle_repose.__doc__)


@spell
def giant_insect(upcast=None):
    '''
    Giant Insect
    4th-level transmutation 
    Casting Time: 1 action  
    ...
    Each creature obeys your verbal commands, and in combat, they act on your turn each round.
     The GM has the statistics for these creatures and resolves their actions and movement.
    ...
    '''
    print(giant_insect.__doc__)


@spell
def glibness(upcast=None):
    '''
    Glibness
    8th-level transmutation 
    Casting Time: 1 action  
    ...
    '''
    print(glibness.__doc__)


@spell
def globe_of_invulnerability(upcast=None):
    '''
    ...
    '''
    print(globe_of_invulnerability.__doc__)


@spell
def glyph_of_warding(upcast=None):
    '''
    Glyph of Warding
    3rd-level abjuration 
    Casting Time: 1 hour  
    ...
    '''
    print(glyph_of_warding.__doc__)


@spell
def goodberry(upcast=None):
    '''
    Goodberry
    1st-level transmutation 
    Casting Time: 1 action  
    ...
    '''
    print(goodberry.__doc__)


@spell
def grease(upcast=None):
    '''
    Grease
    1st-level conjuration 
    Casting Time: 1 action  
    ...
    '''
    print(grease.__doc__)


@spell
def greater_invisibility(upcast=None):
    '''
    ...
    '''
    print(greater_invisibility.__doc__)


@spell
def greater_restoration(upcast=None):
    '''
    Greater Restoration
    5th-level abjuration 
    Casting Time: 1 action  
    ...
    You imbue a creature you touch with positive energy to undo a debilitating effect.
     You can reduce the target's exhaustion level by one, or end one of the following effects on the target:One effect that charmed or petrified the target
    One curse, including the target's attunement to a cursed magic item 
    Any reduction to one of the target's ability scores
    One effect reducing the target's hit point maximum
    '''
    print(greater_restoration.__doc__)


@spell
def guardian_of_faith(upcast=None):
    '''
    Guardian of Faith
    4th-level conjuration 
    Casting Time: 1 action  
    ...
    '''
    print(guardian_of_faith.__doc__)


@spell
def guards_and_wards(upcast=None):
    '''
    Guards and Wards
    6th-level abjuration 
    Casting Time: 10 minutes  
    ...
    Doors.
     All doors in the warded area are magically locked, as if sealed by an arcane lock spell.
    ...
    Stairs.
     Webs fill all stairs in the warded area from top to bottom, as the web spell.
    ...
    Place a suggestion in one location.
    ...
    '''
    print(guards_and_wards.__doc__)


@spell
def guidance(upcast=None):
    '''
    Guidance
    Divination cantrip 
    Casting Time: 1 action  
    ...
    You touch one willing creature.
     ...
     The spell then ends.
    '''
    print(guidance.__doc__)


@spell
def guiding_bolt(upcast=None):
    '''
    Guiding Bolt
    1st-level evocation 
    Casting Time: 1 action 
    ...
    At Higher Levels.
     When you cast this spell using a spell slot of 2nd level or higher, the damage increases by 1d6 for each slot level above 1st.
    '''
    print(guiding_bolt.__doc__)


@spell
def gust_of_wind(upcast=None):
    '''
    Gust of Wind
    2nd-level evocation 
    Casting Time: 1 action  
    ...
    '''
    print(gust_of_wind.__doc__)


@spell
def hallow(upcast=None):
    '''
    Hallow
    5th-level evocation 
    ...
    '''
    print(hallow.__doc__)


@spell
def hallucinatory_terrain(upcast=None):
    '''
    ...
    '''
    print(hallucinatory_terrain.__doc__)


@spell
def harm(upcast=None):
    '''
    Harm
    6th-level necromancy 
    Casting Time: 1 action  
...
def healing_word(upcast=None):
    ...
    '''
    print(healing_word.__doc__)


@spell
def heat_metal(upcast=None):
    '''
    Heat Metal
    2nd-level transmutation 
    Casting Time: 1 action  
    ...
    '''
    print(heat_metal.__doc__)


@spell
def hellish_rebuke(upcast=None):
    '''
    Hellish Rebuke
    1st-level evocation 
    ...
    '''
    print(hellish_rebuke.__doc__)


@spell
def heroes__feast(upcast=None):
    '''
    Heroes' Feast
    6th-level conjuration 
    Casting Time: 10 minutes  
    ...
    '''
    print(heroes__feast.__doc__)


@spell
def heroism(upcast=None):
    '''
    Heroism
    1st-level enchantment 
    Casting Time: 1 action  
    ...
    At Higher Levels.
     When you cast this spell using a spell slot of 2nd level or higher, you can target one additional creature for each slot level above 1st.
    '''
    print(heroism.__doc__)


@spell
def hideous_laughter(upcast=None):
    '''
    Hideous Laughter
    1st-level enchantment 
    Casting Time: 1 action  
    ...
    At the end of each of its turns, and each time it takes damage, the target can make another Wisdom saving throw.
     ...
     On a success, the spell ends.
    '''
    print(hideous_laughter.__doc__)


@spell
def hold_monster(upcast=None):
    '''
    Hold Monster
    5th-level enchantment 
    Casting Time: 1 action  
...
def hold_person(upcast=None):
    ...
    '''
    print(hold_person.__doc__)


@spell
def holy_aura(upcast=None):
    '''
    Holy Aura
    8th-level abjuration 
    Casting Time: 1 action  
    ...
    '''
    print(holy_aura.__doc__)


@spell
def hunter_s_mark(upcast=None):
    '''
    Hunter's Mark
    1st-level divination 
    Casting Time: 1 bonus action  
    ...
    '''
    print(hunter_s_mark.__doc__)


@spell
def hypnotic_pattern(upcast=None):
    '''
    Hypnotic Pattern
    3rd-level illusion 
    Casting Time: 1 action  
    ...
    '''
    print(hypnotic_pattern.__doc__)


@spell
def ice_storm(upcast=None):
    '''
    Ice Storm
    4th-level evocation 
    Casting Time: 1 action  
    ...
    '''
    print(ice_storm.__doc__)


@spell
def identify(upcast=None):
    '''
    Identify
    1st-level divination (ritual) 
    Casting Time: 1 minute  
    ...
    '''
    print(identify.__doc__)


@spell
def illusory_script(upcast=None):
    '''
    Illusory Script
    ...
    '''
    print(illusory_script.__doc__)


@spell
def imprisonment(upcast=None):
    '''
    Imprisonment
    ...
    '''
    print(imprisonment.__doc__)


@spell
def incendiary_cloud(upcast=None):
    '''
    Incendiary Cloud
    8th-level conjuration 
    Casting Time: 1 action  
    ...
    '''
    print(incendiary_cloud.__doc__)


@spell
def inflict_wounds(upcast=None):
    '''
    Inflict Wounds
    1st-level necromancy 
    Casting Time: 1 action  
    ...
    At Higher Levels.
     When you cast this spell using a spell slot of 2nd level or higher, the damage increases by 1d10 for each slot level above 1st.
    '''
    print(inflict_wounds.__doc__)


@spell
def insect_plague(upcast=None):
    '''
    Insect Plague
    5th-level conjuration 
    Casting Time: 1 action  
    ...
    '''
    print(insect_plague.__doc__)


@spell
def instant_summons(upcast=None):
    '''
    Instant Summons
    ...
    '''
    print(instant_summons.__doc__)


@spell
def invisibility(upcast=None):
    '''
    Invisibility
    2nd-level illusion 
    Casting Time: 1 action  
    ...
    At Higher Levels.
     When you cast this spell using a spell slot of 3rd level or higher, you can target one additional creature for each slot level above 2nd.
    '''
    print(invisibility.__doc__)


@spell
def irresistible_dance(upcast=None):
    '''
    Irresistible Dance
    ...
    '''
    print(irresistible_dance.__doc__)


@spell
def jump(upcast=None):
    '''
    Jump
    1st-level transmutation 
    Casting Time: 1 action  
...
def legend_lore(upcast=None):
    ...
    "
    '''
    print(legend_lore.__doc__)


@spell
def lesser_restoration(upcast=None):
    '''
    Lesser Restoration
    2nd-level abjuration 
    Casting Time: 1 action  
    ...
    '''
    print(lesser_restoration.__doc__)


@spell
def levitate(upcast=None):
    '''
    Levitate
    2nd-level transmutation 
    Casting Time: 1 action  
    ...
    '''
    print(levitate.__doc__)


@spell
def light(upcast=None):
    '''
    Light
    Evocation cantrip 
    Casting Time: 1 action  
...
@spell
def lightning_bolt(upcast=None):
    '''
    Lightning Bolt
    3rd-level evocation 
    Casting Time: 1 action  
    ...
    At Higher Levels.
     When you cast this spell using a spell slot of 4th level or higher, the damage increases by 1d6 for each slot level above 3rd.
    '''
    print(lightning_bolt.__doc__)


@spell
def locate_animals_or_plants(upcast=None):
    '''
    ...
    '''
    print(locate_animals_or_plants.__doc__)


@spell
def locate_creature(upcast=None):
    '''
    Locate Creature
    4th-level divination 
    Casting Time: 1 action  
    ...
    '''
    print(locate_creature.__doc__)


@spell
def locate_object(upcast=None):
    '''
    Locate Object
    2nd-level divination 
    Casting Time: 1 action  
    ...
    '''
    print(locate_object.__doc__)


@spell
def longstrider(upcast=None):
    '''
    Longstrider
    1st-level transmutation 
    Casting Time: 1 action  
    ...
    At Higher Levels.
     When you cast this spell using a spell slot of 2nd level or higher, you can target one additional creature for each slot level above 1st.
    '''
    print(longstrider.__doc__)


@spell
def mage_armor(upcast=None):
    '''
    Mage Armor
    ...
    '''
    print(mage_armor.__doc__)


@spell
def mage_hand(upcast=None):
    '''
    Mage Hand
    Conjuration cantrip 
    Casting Time: 1 action  
    ...
    '''
    print(mage_hand.__doc__)


@spell
def magic_circle(upcast=None):
    '''
    Magic Circle
    3rd-level abjuration 
    Casting Time: 1 minute  
    ...
    '''
    print(magic_circle.__doc__)


@spell
def magic_jar(upcast=None):
    '''
    Magic Jar
    6th-level necromancy 
    Casting Time: 1 minute  
    ...
    '''
    print(magic_jar.__doc__)


@spell
def magic_missile(upcast=None):
    '''
    Magic Missile
    1st-level evocation 
    Casting Time: 1 action  
    ...
    '''
    print(magic_missile.__doc__)


@spell
def magic_mouth(upcast=None):
    '''
    Magic Mouth
    ...
    '''
    print(magic_mouth.__doc__)


@spell
def magic_weapon(upcast=None):
    '''
    Magic Weapon
    2nd-level transmutation 
    Casting Time: 1 bonus action  
    ...
    '''
    print(magic_weapon.__doc__)


@spell
def magnificent_mansion(upcast=None):
    '''
    Magnificent Mansion
    7th-level conjuration 
    Casting Time: 1 minute  
    ...
    '''
    print(magnificent_mansion.__doc__)


@spell
def major_image(upcast=None):
    '''
    Major Image
    3rd-level illusion 
    Casting Time: 1 action  
    ...
    '''
    print(major_image.__doc__)


@spell
def mass_cure_wounds(upcast=None):
    '''
    Mass Cure Wounds
    5th-level evocation 
    Casting Time: 1 action  
    ...
    '''
    print(mass_cure_wounds.__doc__)


@spell
def mass_heal(upcast=None):
    '''
    Mass Heal
    9th-level evocation 
    Casting Time: 1 action  
    ...
    A flood of healing energy flows from you into injured creatures around you.
     ...
     This spell has no effect on undead or constructs.
    '''
    print(mass_heal.__doc__)


@spell
def mass_healing_word(upcast=None):
    '''
    Mass Healing Word
    3rd-level evocation 
    Casting Time: 1 bonus action  
    ...
    '''
    print(mass_healing_word.__doc__)


@spell
def mass_suggestion(upcast=None):
    '''
    Mass Suggestion
    6th-level enchantment 
    Casting Time: 1 action  
    ...
    '''
    print(mass_suggestion.__doc__)


@spell
def maze(upcast=None):
    '''
    Maze
    8th-level conjuration 
    Casting Time: 1 action  
...
@spell
def meld_into_stone(upcast=None):
    '''
    Meld into Stone
    ...
    '''
    print(meld_into_stone.__doc__)


@spell
def mending(upcast=None):
    '''
    Mending
    Transmutation cantrip 
    Casting Time: 1 minute  
    ...
    '''
    print(mending.__doc__)


@spell
def message(upcast=None):
    '''
    Message
    Transmutation cantrip 
    Casting Time: 1 action  
...
def meteor_swarm(upcast=None):
    ...
    '''
    print(meteor_swarm.__doc__)


@spell
def mind_blank(upcast=None):
    '''
    Mind Blank
    8th-level abjuration 
    Casting Time: 1 action  
    ...
    '''
    print(mind_blank.__doc__)


@spell
def minor_illusion(upcast=None):
    '''
    Minor Illusion
    Illusion cantrip 
    Casting Time: 1 action  
    ...
    '''
    print(minor_illusion.__doc__)


@spell
def mirage_arcane(upcast=None):
    '''
    Mirage Arcane
    7th-level illusion 
    Casting Time: 10 minutes  
    ...
    '''
    print(mirage_arcane.__doc__)


@spell
def mirror_image(upcast=None):
    '''
    Mirror Image
    2nd-level illusion 
    Casting Time: 1 action  
    ...
    '''
    print(mirror_image.__doc__)


@spell
def mislead(upcast=None):
    '''
    Mislead
    5th-level illusion 
    Casting Time: 1 action  
...
def misty_step(upcast=None):
    ...
    '''
    print(misty_step.__doc__)


@spell
def modify_memory(upcast=None):
    '''
    Modify Memory
    5th-level enchantment 
    Casting Time: 1 action  
    ...
    A modified memory doesn't necessarily affect how a creature behaves, particularly if the memory contradicts the creature's natural inclinations, alignment, or beliefs.
     ...
     The GM might deem a modified memory too nonsensical to affect a creature in a significant manner.
    ...
    '''
    print(modify_memory.__doc__)


@spell
def moonbeam(upcast=None):
    '''
    Moonbeam
    2nd-level evocation 
    Casting Time: 1 action  
    ...
    '''
    print(moonbeam.__doc__)


@spell
def move_earth(upcast=None):
    '''
    Move Earth
    6th-level transmutation 
    Casting Time: 1 action  
    ...
    '''
    print(move_earth.__doc__)


@spell
def nondetection(upcast=None):
    '''
    Nondetection
    3rd-level abjuration 
    Casting Time: 1 action  
    ...
    '''
    print(nondetection.__doc__)


@spell
def pass_without_trace(upcast=None):
    '''
    Pass without Trace
    2nd-level abjuration 
    Casting Time: 1 action  
    ...
    '''
    print(pass_without_trace.__doc__)


@spell
def passwall(upcast=None):
    '''
    Passwall
    5th-level transmutation 
    Casting Time: 1 action  
    ...
    '''
    print(passwall.__doc__)


@spell
def phantasmal_killer(upcast=None):
    '''
    Phantasmal Killer
    4th-level illusion 
    Casting Time: 1 action  
    ...
    '''
    print(phantasmal_killer.__doc__)


@spell
def phantom_steed(upcast=None):
    '''
    Phantom Steed
    ...
    '''
    print(phantom_steed.__doc__)


@spell
def planar_ally(upcast=None):
    '''
    Planar Ally
    6th-level conjuration 
    Casting Time: 10 minutes  
    ...
    '''
    print(planar_ally.__doc__)


@spell
def planar_binding(upcast=None):
    '''
    Planar Binding
    5th-level abjuration 
    Casting Time: 1 hour  
    ...
    '''
    print(planar_binding.__doc__)


@spell
def plane_shift(upcast=None):
    '''
    Plane Shift
    7th-level conjuration
    Casting Time: 1 action  
    ...
    You and up to eight willing creatures who link hands in a circle are transported to a different plane of existence.
     ...
     If you are trying to reach the City of Brass, for example, you might arrive in its Street of Steel, before its Gate of Ashes, or looking at the city from across the Sea of Fire, at the GM's discretion.
    ...
    '''
    print(plane_shift.__doc__)


@spell
def plant_growth(upcast=None):
    '''
    Plant Growth
    3rd-level transmutation 
    ...
    '''
    print(plant_growth.__doc__)


@spell
def poison_spray(upcast=None):
    '''
    Poison Spray
    Conjuration cantrip 
    Casting Time: 1 action  
    ...
    '''
    print(poison_spray.__doc__)


@spell
def polymorph(upcast=None):
    '''
    Polymorph
    4th-level transmutation 
    Casting Time: 1 action  
    ...
    '''
    print(polymorph.__doc__)


@spell
def power_word_kill(upcast=None):
    '''
    Power Word Kill
    ...
    '''
    print(power_word_kill.__doc__)


@spell
def power_word_stun(upcast=None):
    '''
    Power Word Stun
    8th-level enchantment 
    Casting Time: 1 action  
    ...
    '''
    print(power_word_stun.__doc__)


@spell
def prayer_of_healing(upcast=None):
    '''
    Prayer of Healing
    2nd-level evocation 
    Casting Time: 10 minutes  
    ...
    '''
    print(prayer_of_healing.__doc__)


@spell
def prestidigitation(upcast=None):
    '''
    Prestidigitation
    Transmutation cantrip 
    Casting Time: 1 action  
    ...
    This spell is a minor magical trick that novice spellcasters use for practice.
     You create one of the following magical effects within range:You create an instantaneous, harmless sensory effect, such as a shower of sparks, a puff of wind, faint musical notes, or an odd odor.
    ...
    '''
    print(prestidigitation.__doc__)


@spell
def prismatic_spray(upcast=None):
    '''
    Prismatic Spray
    7th-level evocation 
    Casting Time: 1 action  
    ...
    7.
     ...
     If it fails that save, the creature is transported to another plane of existence of the GM's choosing and is no longer blinded.
    ...
    '''
    print(prismatic_spray.__doc__)


@spell
def prismatic_wall(upcast=None):
    '''
    Prismatic Wall
    ...
    7.
     ...
     It must then make a Wisdom saving throw at the start of your next turn.
     A successful save ends the blindness.
     If it fails that save, the creature is transported to another plane of the GM's choosing and is no longer blinded.
     (Typically, a creature that is on a plane that isn't its home plane is banished home, while other creatures are usually cast into the Astral or Ethereal planes.
    ...
    '''
    print(prismatic_wall.__doc__)


@spell
def private_sanctum(upcast=None):
    '''
    Private Sanctum
    4th-level abjuration 
    Casting Time: 10 minutes 
    ...
    '''
    print(private_sanctum.__doc__)


@spell
def produce_flame(upcast=None):
    '''
    Produce Flame
    Conjuration cantrip 
    Casting Time: 1 action  
    ...
    This spell's damage increases by 1d8 when you reach 5th level (2d8), 11th level (3d8), and 17th level (4d8).
    '''
    print(produce_flame.__doc__)


@spell
def programmed_illusion(upcast=None):
    '''
    Programmed Illusion
    6th-level illusion 
    Casting Time: 1 action 
    ...
    '''
    print(programmed_illusion.__doc__)


@spell
def project_image(upcast=None):
    '''
    Project Image
    7th-level illusion 
    Casting Time: 1 action  
    ...
    Physical interaction with the image reveals it to be an illusion, because things can pass through it.
     ...
     If a creature discerns the illusion for what it is, the creature can see through the image, and any noise it makes sounds hollow to the creature.
    '''
    print(project_image.__doc__)


@spell
def protection_from_energy(upcast=None):
    '''
    ...
    '''
    print(protection_from_energy.__doc__)


@spell
def protection_from_evil_and_good(upcast=None):
    '''
    ...
    '''
    print(protection_from_evil_and_good.__doc__)


@spell
def protection_from_poison(upcast=None):
    '''
    ...
    '''
    print(protection_from_poison.__doc__)


@spell
def purify_food_and_drink(upcast=None):
    '''
    ...
    '''
    print(purify_food_and_drink.__doc__)


@spell
def raise_dead(upcast=None):
    '''
    Raise Dead
    5th-level necromancy 
    Casting Time: 1 hour  
    ...
    '''
    print(raise_dead.__doc__)


@spell
def ray_of_enfeeblement(upcast=None):
    '''
    Ray of Enfeeblement
    2nd-level necromancy 
    Casting Time: 1 action  
    ...
    At the end of each of the target's turns, it can make a Constitution saving throw against the spell.
     On a success, the spell ends.
    '''
    print(ray_of_enfeeblement.__doc__)


@spell
def ray_of_frost(upcast=None):
    '''
    Ray of Frost
    Evocation cantrip 
    Casting Time: 1 action  
    ...
    '''
    print(ray_of_frost.__doc__)


@spell
def regenerate(upcast=None):
    '''
    Regenerate
    7th-level transmutation 
    Casting Time: 1 minute  
    ...
    '''
    print(regenerate.__doc__)


@spell
def reincarnate(upcast=None):
    '''
    Reincarnate
    5th-level transmutation 
    Casting Time: 1 hour  
    ...
    Half-elf57-60
    Half-orc61-68
    Halfling, lightfoot69-76
    Halfling, stout77-96
    Human97-100
    TieflingThe reincarnated creature recalls its former life and experiences.
    ...
    '''
    print(reincarnate.__doc__)


@spell
def remove_curse(upcast=None):
    '''
    Remove Curse
    3rd-level abjuration 
    Casting Time: 1 action  
    ...
    '''
    print(remove_curse.__doc__)


@spell
def resilient_sphere(upcast=None):
    '''
    Resilient Sphere
    4th-level evocation 
    Casting Time: 1 action  
    ...
    '''
    print(resilient_sphere.__doc__)


@spell
def resistance(upcast=None):
    '''
    Resistance
    Abjuration cantrip 
    Casting Time: 1 action  
...
def resurrection(upcast=None):
    ...
    '''
    print(resurrection.__doc__)


@spell
def reverse_gravity(upcast=None):
    '''
    Reverse Gravity
    7th-level transmutation 
    Casting Time: 1 action  
    ...
    '''
    print(reverse_gravity.__doc__)


@spell
def revivify(upcast=None):
    '''
    Revivify
    3rd-level necromancy 
    Casting Time: 1 action  
    ...
    '''
    print(revivify.__doc__)


@spell
def rope_trick(upcast=None):
    '''
    Rope Trick
    2nd-level transmutation 
    Casting Time: 1 action  
    ...
    '''
    print(rope_trick.__doc__)


@spell
def sacred_flame(upcast=None):
    '''
    Sacred Flame
    Evocation cantrip 
    Casting Time: 1 action  
    ...
    The spell's damage increases by 1d8 when you reach 5th level (2d8), 11th level (3d8), and 17th level (4d8).
    '''
    print(sacred_flame.__doc__)


@spell
def sanctuary(upcast=None):
    '''
    Sanctuary
    1st-level abjuration 
    Casting Time: 1 bonus action  
    ...
    '''
    print(sanctuary.__doc__)


@spell
def scorching_ray(upcast=None):
    '''
    Scorching Ray
    2nd-level evocation 
    Casting Time: 1 action  
    ...
    '''
    print(scorching_ray.__doc__)


@spell
def scrying(upcast=None):
    '''
    Scrying
    5th-level divination 
    Casting Time: 10 minutes  
    ...
    You can see and hear a particular creature you choose that is on the same plane of existence as you.
     ...
     Knowledge
    Save ModifierSecondhand (you have heard of the target)
    +5Firsthand (you have met the target)
    0Familiar (you know the target well)
    -5Connection
    Save ModifierLikeness or picture
    -2Possession or garment
    -4Body part, lock of hair, bit of nail, or the like
    -10On a successful save, the target isn't affected, and you can't use this spell against it again for 24 hours.
    ...
    '''
    print(scrying.__doc__)


@spell
def secret_chest(upcast=None):
    '''
    Secret Chest
    4th-level conjuration 
    Casting Time: 1 action  
    ...
    '''
    print(secret_chest.__doc__)


@spell
def see_invisibility(upcast=None):
    '''
    See Invisibility
    2nd-level divination 
    Casting Time: 1 action  
    ...
    '''
    print(see_invisibility.__doc__)


@spell
def seeming(upcast=None):
    '''
    Seeming
    5th-level illusion 
    Casting Time: 1 action  
    ...
    '''
    print(seeming.__doc__)


@spell
def sending(upcast=None):
    '''
    Sending
    3rd-level evocation 
    Casting Time: 1 action  
    ...
    '''
    print(sending.__doc__)


@spell
def sequester(upcast=None):
    '''
    Sequester
    7th-level transmutation 
    Casting Time: 1 action  
    ...
    '''
    print(sequester.__doc__)


@spell
def shapechange(upcast=None):
    '''
    Shapechange
    ...
    When you transform, you choose whether your equipment falls to the ground, merges into the new form, or is worn by it.
     ...
     The GM determines whether it is practical for the new form to wear a piece of equipment, based on the creature's shape and size.
    ...
    '''
    print(shapechange.__doc__)


@spell
def shatter(upcast=None):
    '''
    Shatter
    2nd-level evocation 
    Casting Time: 1 action  
...
def shield(upcast=None):
    ...
    '''
    print(shield.__doc__)


@spell
def shield_of_faith(upcast=None):
    '''
    Shield of Faith
    1st-level abjuration 
    Casting Time: 1 bonus action  
    ...
    '''
    print(shield_of_faith.__doc__)


@spell
def shillelagh(upcast=None):
    '''
    Shillelagh
    Transmutation cantrip 
    Casting Time: 1 bonus action  
    ...
    '''
    print(shillelagh.__doc__)


@spell
def shocking_grasp(upcast=None):
    '''
    Shocking Grasp
    Evocation cantrip 
    Casting Time: 1 action  
    ...
    The spell's damage increases by 1d8 when you reach 5th level (2d8), 11th level (3d8), and 17th level (4d8).
    '''
    print(shocking_grasp.__doc__)


@spell
def silence(upcast=None):
    '''
    Silence
    2nd-level illusion (ritual) 
    Casting Time: 1 action  
    ...
    '''
    print(silence.__doc__)


@spell
def silent_image(upcast=None):
    '''
    Silent Image
    1st-level illusion 
    Casting Time: 1 action  
    ...
    '''
    print(silent_image.__doc__)


@spell
def simulacrum(upcast=None):
    '''
    Simulacrum
    7th-level illusion 
...
def sleet_storm(upcast=None):
    ...
    '''
    print(sleet_storm.__doc__)


@spell
def slow(upcast=None):
    '''
    Slow
    3rd-level transmutation 
    Casting Time: 1 action  
...
@spell
def spare_the_dying(upcast=None):
    '''
    Spare the Dying
    Necromancy cantrip 
    Casting Time: 1 action  
    ...
    You touch a living creature that has 0 hit points.
     ...
     This spell has no effect on undead or constructs.
    '''
    print(spare_the_dying.__doc__)


@spell
def speak_with_animals(upcast=None):
    '''
    Speak with Animals
    1st-level divination (ritual) 
    Casting Time: 1 action  
    ...
    '''
    print(speak_with_animals.__doc__)


@spell
def speak_with_dead(upcast=None):
    '''
    Speak with Dead
    3rd-level necromancy 
    Casting Time: 1 action  
    ...
    '''
    print(speak_with_dead.__doc__)


@spell
def speak_with_plants(upcast=None):
    '''
    Speak with Plants
    3rd-level transmutation 
    Casting Time: 1 action  
    ...
    Plants might be able to perform other tasks on your behalf, at the GM's discretion.
    ...
    '''
    print(speak_with_plants.__doc__)


@spell
def spider_climb(upcast=None):
    '''
    Spider Climb
    2nd-level transmutation 
    Casting Time: 1 action  
    ...
    '''
    print(spider_climb.__doc__)


@spell
def spike_growth(upcast=None):
    '''
    Spike Growth
    2nd-level transmutation 
    Casting Time: 1 action  
    ...
    '''
    print(spike_growth.__doc__)


@spell
def spirit_guardians(upcast=None):
    '''
    Spirit Guardians
    3rd-level conjuration 
    Casting Time: 1 action  
    ...
    '''
    print(spirit_guardians.__doc__)


@spell
def spiritual_weapon(upcast=None):
    '''
    Spiritual Weapon
    2nd-level evocation 
    Casting Time: 1 bonus action  
    ...
    '''
    print(spiritual_weapon.__doc__)


@spell
def stinking_cloud(upcast=None):
    '''
    Stinking Cloud
    3rd-level conjuration 
    Casting Time: 1 action  
    ...
    '''
    print(stinking_cloud.__doc__)


@spell
def stone_shape(upcast=None):
    '''
    Stone Shape
    4th-level transmutation 
    Casting Time: 1 action  
    ...
    '''
    print(stone_shape.__doc__)


@spell
def stoneskin(upcast=None):
    '''
    Stoneskin
    4th-level abjuration 
    Casting Time: 1 action  
    ...
    '''
    print(stoneskin.__doc__)


@spell
def storm_of_vengeance(upcast=None):
    '''
    Storm of Vengeance
    9th-level conjuration 
    Casting Time: 1 action  
    ...
    '''
    print(storm_of_vengeance.__doc__)


@spell
def suggestion(upcast=None):
    '''
    Suggestion
    2nd-level enchantment 
    Casting Time: 1 action  
    ...
    '''
    print(suggestion.__doc__)


@spell
def sunbeam(upcast=None):
    '''
    Sunbeam
    6th-level evocation 
    Casting Time: 1 action  
    ...
    '''
    print(sunbeam.__doc__)


@spell
def sunburst(upcast=None):
    '''
    Sunburst
    8th-level evocation 
    Casting Time: 1 action  
    ...
    '''
    print(sunburst.__doc__)


@spell
def symbol(upcast=None):
    '''
    Symbol
...
def telekinesis(upcast=None):
    ...
    '''
    print(telekinesis.__doc__)


@spell
def telepathic_bond(upcast=None):
    '''
    Telepathic Bond
    5th-level divination (ritual) 
    Casting Time: 1 action  
    ...
    '''
    print(telepathic_bond.__doc__)


@spell
def teleport(upcast=None):
    '''
    Teleport
    7th-level conjuration 
    Casting Time: 1 action  
    ...
    Similar Area
    Off Target
    On TargetPermanent circle
    -
    -
    -
    01-100Associated object
    -
    -
    -
    01-100Very familiar
    ...
    Mishap.
     ...
     Each teleporting creature (or the target object) takes 3d10 force damage, and the GM rerolls on the table to see where you wind up (multiple mishaps can occur, dealing damage each time).
    '''
    print(teleport.__doc__)


@spell
def teleportation_circle(upcast=None):
    '''
    ...
    '''
    print(teleportation_circle.__doc__)


@spell
def thaumaturgy(upcast=None):
    '''
    Thaumaturgy
    Transmutation cantrip 
    Casting Time: 1 action  
    ...
    You manifest a minor wonder, a sign of supernatural power, within range.
     You create one of the following magical effects within range:Your voice booms up to three times as loud as normal for 1 minute.
    ...
    '''
    print(thaumaturgy.__doc__)


@spell
def thunderwave(upcast=None):
    '''
    Thunderwave
    1st-level evocation 
    Casting Time: 1 action  
    ...
    '''
    print(thunderwave.__doc__)


@spell
def time_stop(upcast=None):
    '''
    Time Stop
    9th-level transmutation 
    Casting Time: 1 action  
    ...
    '''
    print(time_stop.__doc__)


@spell
def tiny_hut(upcast=None):
    '''
    Tiny Hut
    ...
    '''
    print(tiny_hut.__doc__)


@spell
def tongues(upcast=None):
    '''
    Tongues
    3rd-level divination 
    Casting Time: 1 action  
...
@spell
def transport_via_plants(upcast=None):
    '''
    ...
    '''
    print(transport_via_plants.__doc__)


@spell
def tree_stride(upcast=None):
    '''
    Tree Stride
    5th-level conjuration 
    Casting Time: 1 action  
    ...
    '''
    print(tree_stride.__doc__)


@spell
def true_polymorph(upcast=None):
    '''
    True Polymorph
    9th-level transmutation 
    Casting Time: 1 action  
    ...
    Object into Creature.
     ...
     The GM has the creature's statistics and resolves all of its actions and movement.
    ...
    '''
    print(true_polymorph.__doc__)


@spell
def true_resurrection(upcast=None):
    '''
    True Resurrection
    9th-level necromancy 
    Casting Time: 1 hour  
    ...
    '''
    print(true_resurrection.__doc__)


@spell
def true_seeing(upcast=None):
    '''
    True Seeing
    6th-level divination 
    Casting Time: 1 action  
    ...
    '''
    print(true_seeing.__doc__)


@spell
def true_strike(upcast=None):
    '''
    True Strike
    Divination cantrip 
    Casting Time: 1 action  
    ...
    '''
    print(true_strike.__doc__)


@spell
def unseen_servant(upcast=None):
    '''
    Unseen Servant
    1st-level conjuration (ritual) 
    Casting Time: 1 action  
    ...
    '''
    print(unseen_servant.__doc__)


@spell
def vampiric_touch(upcast=None):
    '''
    Vampiric Touch
    3rd-level necromancy 
    Casting Time: 1 action  
    ...
    At Higher Levels.
     When you cast this spell using a spell slot of 4th level or higher, the damage increases by 1d6 for each slot level above 3rd.
    '''
    print(vampiric_touch.__doc__)


@spell
def vicious_mockery(upcast=None):
    '''
    Vicious Mockery
    Enchantment cantrip 
    Casting Time: 1 action  
    ...
    '''
    print(vicious_mockery.__doc__)


@spell
def wall_of_fire(upcast=None):
    '''
    Wall of Fire
    4th-level evocation 
    Casting Time: 1 action  
    ...
    At Higher Levels.
     When you cast this spell using a spell slot of 5th level or higher, the damage increases by 1d8 for each slot level above 4th.
    '''
    print(wall_of_fire.__doc__)


@spell
def wall_of_force(upcast=None):
    '''
    Wall of Force
    5th-level evocation 
    Casting Time: 1 action  
    ...
    Nothing can physically pass through the wall.
     It is immune to all damage and can't be dispelled by dispel magic.
    ...
    '''
    print(wall_of_force.__doc__)


@spell
def wall_of_ice(upcast=None):
    '''
    Wall of Ice
    6th-level evocation 
    Casting Time: 1 action  
    ...
    '''
    print(wall_of_ice.__doc__)


@spell
def wall_of_stone(upcast=None):
    '''
    Wall of Stone
    5th-level evocation 
    Casting Time: 1 action  
    ...
    '''
    print(wall_of_stone.__doc__)


@spell
def wall_of_thorns(upcast=None):
    '''
    Wall of Thorns
    6th-level conjuration 
    Casting Time: 1 action  
    ...
    '''
    print(wall_of_thorns.__doc__)


@spell
def warding_bond(upcast=None):
    '''
    Warding Bond
    2nd-level abjuration 
    Casting Time: 1 action  
    ...
    '''
    print(warding_bond.__doc__)


@spell
def water_breathing(upcast=None):
    '''
    Water Breathing
    3rd-level transmutation (ritual) 
    Casting Time: 1 action  
    ...
    '''
    print(water_breathing.__doc__)


@spell
def water_walk(upcast=None):
    '''
    Water Walk
    3rd-level transmutation (ritual) 
    Casting Time: 1 action 
...
def wind_walk(upcast=None):
    ...
    '''
    print(wind_walk.__doc__)


@spell
def wind_wall(upcast=None):
    '''
    Wind Wall
    3rd-level evocation 
    Casting Time: 1 action  
    ...
    '''
    print(wind_wall.__doc__)


@spell
def wish(upcast=None):
    '''
    Wish
    9th-level conjuration 
    Casting Time: 1 action  
...
@spell
def word_of_recall(upcast=None):
    '''
    Word of Recall
    6th-level conjuration 
    Casting Time: 1 action  
    ...
    '''
    print(word_of_recall.__doc__)


@spell
def zone_of_truth(upcast=None):
    '''
    Zone of Truth
    2nd-level enchantment 
    Casting Time: 1 action  
